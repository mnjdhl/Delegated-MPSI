...
output_file="MileStone5_Fig2_Parties_vs_SetSizes_h_$HashCount_$file_id.txt"
echo "Running for Bandwith=$BytesPerSec, Latency=$Latency, Hash Count=$HashCount, Hash Function=$HashFunc and Repetitions=$Repetitions">>$output_file
echo "Set Size, Pary Count, Time (s)" >> $output_file
...
do
    ...
    do
        ...
        msg="$SetSize, $PartyCount, $avg_time"
