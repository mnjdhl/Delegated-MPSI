...
/* Method Definitions for 'Channels' class */
...
explicit Set::Set(std::initializer_list<size_t> init) : elements(init) {}

static Set Set::intersection(const std::vector<Set>& sets) {
