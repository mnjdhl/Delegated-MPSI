...
g++ -o delegated_mpsi main.cpp secret_sharing_simd.o approx_mpsi.o Channels.o FullMesh.o -g -lblake3 -lboost_program_options -I/usr/lib/include/ -L/usr/bin/lib/ -std=c++17
