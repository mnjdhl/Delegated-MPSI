...
private:
	...
	bigint* unblind_BF_(bigint BF, int indx, uint8_t* BF_key, uint8_t* BF_iv, bigint pr_moduli);
	bigint* blind_BF_(bigint bf, int indx, uint8_t* BF_key, uint8_t* BF_iv, bigint pr_moduli);
	bigint* blind_BFs_(bigint* bf, int bf_size, uint8_t* BF_key, uint8_t* BF_iv, bigint pr_moduli);
	bigint* unblind_BFs_(bigint* BF,int bf_size, uint8_t* BF_key, uint8_t* BF_iv, bigint pr_moduli);
  	bigint* gen_BF_PRN_(int indx , int counter, uint8_t* BF_key, uint8_t* BF_iv);
	...
	bigint** gen_map_ (int size, uint8_t* label_key1, uint8_t* label_iv1, uint8_t* label_key2, uint8_t* label_iv2, int byte_);
	...
	bigint** blind_shuffled_bl_(bigint** s_bl, int table_size, uint8_t *key, uint8_t* iv, int key_size, int num_of_PRNs_, int byte_, bigint pubmoduli_);
	...
	bloom_parameters bf_parameters;
  	uint8_t seed_[AES::DEFAULT_KEYLENGTH];
  	uint8_t iv[AES::BLOCKSIZE];
  	uint8_t BF_key_[AES::DEFAULT_KEYLENGTH];
  	uint8_t BF_iv[AES::BLOCKSIZE];
