...
public:
	...
	Server_Result * compute_result (GrantComp_Info** grantComp_info, uint8_t* tmp_key_, uint8_t *tmp_iv_);
	...
	void regen_PRpolys(uint8_t* temp_key, uint8_t* temp_iv, bigint**& w_A_, bigint **& w_B_, bigint**& a, uint8_t* temp_key_2, uint8_t* temp_iv_2);
