...
bigint* Random::gen_bin_PRNs_(uint8_t *key, uint8_t* iv, int key_size, int indx, int counter_indx, int num_of_PRNs,int byte_){
...
bigint** Random::gen_HT_RRNs_(uint8_t *key, uint8_t* iv, int key_size, int HT_size, int* counter_indx, int num_of_PRNs, int byte_){
...
bigint* Random::gen_PRN_(uint8_t *key, uint8_t* iv, int key_size, int indx, int byte_, int table_size){
...
bigint* Random::gen_PRNs_(uint8_t *key, uint8_t* iv, int key_size, int number_of_PRNs, int byte_, int table_size){
...
bigint** Random::gen_PRNs_forBins(int table_size, uint8_t* key, uint8_t* iv, int key_size, int bin_cap, int byte_, bigint pubmoduli_){
