...
bigint* Polynomial::blind_poly_(bigint* y_coordinates, int val_size_, uint8_t *key, uint8_t* iv, int key_size, int indx, int counter_indx, int byte_, bigint pubmod){
...
void Polynomial::blind_poly_(uint8_t *key, uint8_t* iv, int key_size, int indx, int counter_indx, int byte_, bigint pubmod){
...
bigint* Polynomial::unblind_poly_(bigint* blinded_vals, int num_of_vals, uint8_t* key, uint8_t* iv, int key_size, int indx, int counter_indx, int byte_, bigint pubmod){
